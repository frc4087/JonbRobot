...
/**
 * Command that drives forward for a given duration at a given speed, with no
 * refinement (error correction, input profiling).
 */
public class RawDriveDuration extends Command {
	/**
	 * Creates an instance.
	 ...
	 */
	public RawDriveDuration(CommandDrivable drive, double speedFactor,
			double duration) {
		_drive = drive;
